...
public class BoardListIntegrationTest extends AbstractIntegrationTest {
    ...
    public void list_success_secondPage() throws Exception {
        ...
        resultActions
                ...
                .andExpect(jsonPath("$.data.boardList.content[1].boardId").value(6))
                .andExpect(jsonPath("$.data.boardList.content[1].title").value("제목6"))
                .andExpect(jsonPath("$.data.boardList.content[1].views").value("60"))
                .andExpect(jsonPath("$.data.boardList.content[1].commentCount").value(0))
                .andExpect(jsonPath("$.data.boardList.content[1].user.userId").value(2))
                .andExpect(jsonPath("$.data.boardList.content[1].user.username").value("user2"))

                .andExpect(jsonPath("$.data.boardList.content[2].boardId").value(5))
                .andExpect(jsonPath("$.data.boardList.content[2].title").value("제목5"))
                .andExpect(jsonPath("$.data.boardList.content[2].views").value("50"))
                .andExpect(jsonPath("$.data.boardList.content[2].commentCount").value(0))
                .andExpect(jsonPath("$.data.boardList.content[2].user.userId").value(1))
                .andExpect(jsonPath("$.data.boardList.content[2].user.username").value("user1"))

                .andExpect(jsonPath("$.data.boardList.content[3].boardId").value(4))
                .andExpect(jsonPath("$.data.boardList.content[3].title").value("제목4"))
                .andExpect(jsonPath("$.data.boardList.content[3].views").value("40"))
                .andExpect(jsonPath("$.data.boardList.content[3].commentCount").value(0))
                .andExpect(jsonPath("$.data.boardList.content[3].user.userId").value(1))
                .andExpect(jsonPath("$.data.boardList.content[3].user.username").value("user1"))
